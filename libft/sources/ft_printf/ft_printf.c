...
/*   Updated: 2024/03/15 18:50:45 by chuchard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/ft_printf.h"

static int	ft_putbase(unsigned long long n, char *base,
		unsigned long long baserange, char argtype)
{
	int		i;
	char	buffer[50];
	int		count;
...
static int	ft_write_arg(char argtype, va_list arg)
{
	if (argtype == 'c')
		...
		return (ft_putbase((unsigned long long)va_arg(arg, void *), HEXA_LOW,
				16, argtype));
